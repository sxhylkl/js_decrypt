                        ...
                        while (r !== 14) {
                            switch (r) {
                                ...
                                case 5:
                                    ...
                                    break;
                                case 9:
                                    c += String.fromCharCode(B.charCodeAt(M) ^ e.charCodeAt(f));
                                    r = 8;
                                    break;
                                case 7:
                                    c = c.split('}');
...
B8RR.S3C = function () {
    return typeof B8RR.w3C.I === 'function' ? B8RR.w3C.I.apply(B8RR.w3C, arguments) : B8RR.w3C.I;
}
;
B8RR.V2Z = function () {
    return typeof B8RR.d2Z.I === 'function' ? B8RR.d2Z.I.apply(B8RR.d2Z, arguments) : B8RR.d2Z.I;
}
;
B8RR.G3C = 5;
B8RR.n2Z = function () {
...
function en(d8C, Q1Y) {
    var C8Z = f2Z.V2Z()[5][0][36];
    while (C8Z !== f2Z.V2Z()[20][22][46]) {
        switch (C8Z) {
            case f2Z.n2Z()[37][16][4]:
                C8Z = S5C * (S5C + 1) % 2 + 1 && D1Y < P1Y[f2Z.t3C(462)] ? f2Z.V2Z()[28][14][38] : f2Z.n2Z()[47][8][20];
                break;
            case f2Z.V2Z()[16][38][26][14]:
                C8Z = t5C * (t5C + 1) * t5C % 2 == 0 && D1Y < Y8C ? f2Z.n2Z()[11][31][31] : f2Z.n2Z()[40][18][42];
                break;
            case f2Z.n2Z()[40][1][13]:
                D1Y++;
                C8Z = f2Z.n2Z()[19][40][4];
                break;
            case f2Z.n2Z()[43][2][10][38]:
                var c1Y = P1Y[f2Z.S3C(459)](D1Y);
                L1Y[D1Y] = c1Y > 57 ? c1Y - 87 : c1Y - 48;
                S5C = S5C >= 59058 ? S5C - 3 : S5C + 3;
                C8Z = f2Z.n2Z()[20][1][13];
                break;
            case f2Z.n2Z()[12][19][7]:
                p5C = p5C > 13053 ? p5C - 2 : p5C + 2;
                C8Z = f2Z.n2Z()[42][40][16];
                break;
            case f2Z.V2Z()[21][30][42]:
                var s8C, q8C = C8C, k1Y = 4, A8C = f2Z.t3C(419), e8C = [1, 2, 5, 10, 50];
                C8Z = f2Z.V2Z()[21][28][16];
                break;
            case f2Z.n2Z()[15][35][35]:
                return A8C;
                C8Z = f2Z.n2Z()[46][46][46];
                break;
            case f2Z.V2Z()[31][14][36][26]:
                D1Y++;
                C8Z = f2Z.n2Z()[34][14][14];
                break;
            case f2Z.V2Z()[2][19][31]:
                U1Y = Q1Y[f2Z.S3C(605)](D1Y),
                B8C[U1Y] || (B8C[U1Y] = 1,
                    l1Y[y1Y][f2Z.S3C(617)](U1Y),
                    y1Y++,
                    y1Y = 5 == y1Y ? 0 : y1Y);
                t5C = t5C > 45447 ? t5C - 8 : t5C + 8;
                C8Z = f2Z.n2Z()[33][38][2][2];
                break;
            case f2Z.V2Z()[38][33][21]:
                var P1Y = Q1Y[f2Z.t3C(181)](32)
                    , L1Y = []
                    , D1Y = 0;
                C8Z = f2Z.V2Z()[20][4][4];
                break;
            case f2Z.V2Z()[11][13][37]:
                q8C - e8C[k1Y] >= 0 ? (s8C = parseInt(Math[f2Z.t3C(338)]() * l1Y[k1Y][f2Z.t3C(462)], 10),
                    A8C += l1Y[k1Y][s8C],
                    q8C -= e8C[k1Y]) : (l1Y[f2Z.t3C(273)](k1Y, 1),
                    e8C[f2Z.t3C(273)](k1Y, 1),
                    k1Y -= 1);
                C8Z = f2Z.n2Z()[41][31][7];
                break;
            case f2Z.V2Z()[8][20][20]:
                P1Y = 36 * L1Y[0] + L1Y[1];
                var C8C = Math[f2Z.S3C(50)](d8C) + P1Y;
                Q1Y = Q1Y[f2Z.S3C(181)](0, 32);
                var U1Y, l1Y = [[], [], [], [], []], B8C = {}, y1Y = 0;
                D1Y = 0;
                C8Z = f2Z.n2Z()[33][19][43];
                break;
            case f2Z.n2Z()[4][16][16]:
                C8Z = q8C > 0 && p5C * (p5C + 1) % 2 + 10 ? f2Z.n2Z()[11][13][37] : f2Z.n2Z()[5][11][35];
                break;
            case f2Z.V2Z()[16][36][36]:
                var p5C = 5;
                var t5C = 4;
                var S5C = 7;
                C8Z = f2Z.V2Z()[26][33][21];
                break;
            case f2Z.V2Z()[2][31][43]:
                var Y8C = Q1Y[f2Z.S3C(462)];
                C8Z = f2Z.V2Z()[30][14][14];
                break;
        }
    }
}
...
function enAll(distance, r1, r2, challenge) {
    return en(distance, challenge) + '_' + en(r1, challenge) + '_' + en(r2, challenge);
}

function getDistance(r1, r2) {
    for (var f = r1.slice(0, 9), g = r2.slice(10, 19), h = "", i = 0; i < 9; i++)
...
var d = getDistance('c81e728d9d4c2f636f067f89cc14862c', '077e29b11be80ab57e1a2ecabb7da330')
console.log(d)
// d = 54;
// r1 = parseInt(6 * Math.random());
// // r1=3
// // r2=145
// r2 = parseInt(300 * Math.random());
// cha = '93db85ed909c13838ff95ccfa94cebd91f'
// console.log(r1, r2)
// res = enAll(d, r1, r2, cha)
// console.log(res)